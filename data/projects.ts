...
Обсудить сотрудничество: @ir6eas3`,
  ...
  },
  {
    ...
    year: '2026',
    description:
      'Личный аккаунт. Только Reels, органика — без рекламы и накрутки. 166 389 просмотров, 123 855 охваченных аккаунтов (+1 934%), 100+ подписчиков за 10 дней. Рекордный Reels: 47 946 просмотров, 1 100 лайков.',
    longDescription: `Личный аккаунт. Только Reels, органика — без рекламы и накрутки.

Результаты за 14 дней:
— 166 389 просмотров
— 123 855 охваченных аккаунтов (+1 934%)
— 98,6% — новая аудитория (холодный охват)
...
— 45 подписок с одного видео`,
    ...
    featured: true,
    stats: [
      { value: '166 389', label: 'просмотров' },
      { value: '123 855', label: 'охваченных' },
      { value: '+1 934%', label: 'рост охвата' },
    ],
  },
  {
    id: 2,
